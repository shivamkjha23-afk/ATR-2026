...
function setupPermitPlanningPage() {
  ...
  async function runPermitFlowForRow(row, commonInput) {
    ...
    try {
      ...
      message.textContent = 'SUGAM tab opened with encoded payload. Bookmarklet code copied—click it after SSO login in that tab.';
    } catch (_) {
